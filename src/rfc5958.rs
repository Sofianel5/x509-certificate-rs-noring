...
impl OneAsymmetricKey {
    pub fn take_from<S: Source>(cons: &mut Constructed<S>) -> Result<Self, DecodeError<S::Error>> {
        cons.take_sequence(|cons| {
            ...
            // Note: legacy versions of ring incorrectly encoded the public key as a
            // constructed/nested value. We changed this code to the proper form. But
            // PKCS#8 keys generated by the old code were technically invalid.
            let public_key = cons.take_opt_value_if(Tag::CTX_1, |c| BitString::from_content(c))?;
